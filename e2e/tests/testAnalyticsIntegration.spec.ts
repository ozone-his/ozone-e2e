...
test('Making an order updates orders table in Analytics', async ({ page }) => {
  ...
  // const initialNumberOfItems =   await page.locator(".ReactVirtualized__Table__rowColumn").innerText();
  ...
  // await page.getByRole('textbox').fill('SELECT COUNT(*) FROM _orders;');
  // await homePage.runSQLQuery();
  // const updatedNumberOfItems =   await page.locator(".ReactVirtualized__Table__rowColumn").innerText();
